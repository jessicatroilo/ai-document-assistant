 ...
 */
class getDocumentAnalysisControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\DocumentAnalysisController' shared autowired service.
     *
     * @return \App\Controller\DocumentAnalysisController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/DocumentAnalysisController.php';

        $container->services['App\\Controller\\DocumentAnalysisController'] = $instance = new \App\Controller\DocumentAnalysisController();
        ...
        ]))->withContext('App\\Controller\\DocumentAnalysisController', $container));
